...
import { ChromeTransactionDurability } from "./mabnaDB-constructor";
...
export interface DBCoreIndex {
    ...
    /** True if this index represents the primary key and is not inbound (https://mabnadb.com/docs/inbound) */
    readonly outbound?: boolean;
    /** True if and only if keyPath is an array (https://mabnadb.com/docs/Compound-Index) */
